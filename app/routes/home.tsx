      ...
      <section className="p-8">
        <div>
          <p className="flex items-center gap-3">
            Stay in touch:
            <a target="_blank" href="https://github.com/JetBrains/kotlin" title="Kotlin on GitHub" className="inline-flex items-center text-current hover:opacity-75">
            ...
            <a target="_blank" href="https://twitter.com/kotlin" title="Kotlin on Twitter" className="inline-flex items-center text-current hover:opacity-75">
            ...
            <a target="_blank" href="https://surveys.jetbrains.com/s3/kotlin-slack-sign-up" title="Kotlin Slack" className="inline-flex items-center text-current hover:opacity-75">
            ...
            <a target="_blank" href="https://www.reddit.com/r/Kotlin/" title="Kotlin on Reddit" className="inline-flex items-center text-current hover:opacity-75">
            ...
            <a target="_blank" href="https://stackoverflow.com/questions/tagged/kotlin" title="Kotlin on Stack Overflow" className="inline-flex items-center text-current hover:opacity-75">
            ...
            <a target="_blank" href="https://www.youtube.com/channel/UCP7uiEZIqci43m22KDl0sNw" title="Kotlin on YouTube" className="inline-flex items-center text-current hover:opacity-75">
